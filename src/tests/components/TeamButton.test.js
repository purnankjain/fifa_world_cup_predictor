...
describe('Team Button tests', () => {
  it('should render a box with team name', () => {
    var teamButtonComponent = (<TeamButton name={teamName} winnerCallback={() => {}} rollbackWinnerCallback={() => {}}/>)
  ...
  it('should be clickable to set team as group winner', () => {
    ...
    var teamButtonComponent = (<TeamButton name={teamName} winnerCallback={incrementWinnerCallbackCount} rollbackWinnerCallback={() => {}}/>)
  ...
  it('should be clickable to rollback group winner', () => {
    ...
    var teamButtonComponent = (<TeamButton name={teamName} rollbackWinnerCallback={incrementRollbackWinnerCallbackCount} winnerCallback={() => {}} isWinner/>)
    var teamButtonWinner = TestUtils.renderIntoDocument(teamButtonComponent);
    var teamButtonNode = ReactDOM.findDOMNode(teamButtonWinner);
